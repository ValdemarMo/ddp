...
class User(AbstractUser):
    ...
    user_permissions = models.ManyToManyField(
        ...
        blank=True,
        related_name='custom_permissions_users',
        related_query_name='custom_user',
    )
...
class Shop(models.Model):
    ...
    filename = models.FileField(upload_to='shop_data/', verbose_name='Файл с данными о магазине', null=True, blank=True)
...
class OrderItem(models.Model):
    ...
    product_info = models.ForeignKey(ProductInfo, verbose_name='Информация о товаре', related_name='ordered_items',
                                     ...
                                     on_delete=models.CASCADE)
    quantity = models.PositiveIntegerField(verbose_name='Количество')
    shop = models.ForeignKey(Shop, verbose_name='Магазин', related_name='order_items',
